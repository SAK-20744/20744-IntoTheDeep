...
import static org.firstinspires.ftc.teamcode.config.NewFieldConstants.*;
...
import org.firstinspires.ftc.teamcode.opModes.TeleOps.Blue;
...
//        sample1ControlPose = blueBucketLeftSampleControlPose;
        element1Pose = blueBucketRightSamplePose;
...
//        sample3ControlPose = blueBucketRightSampleControlPose;
        element3Pose = blueBucketLeftSamplePose;
    ...
    public void buildPaths() {
        ...
        element2 = new Path(new BezierCurve(new Point(elementScorePose), new Point(element2Pose)));
        element2.setLinearHeadingInterpolation(elementScorePose.getHeading(), element2Pose.getHeading(), 0.5);

        score2 = new Path(new BezierLine(new Point(element2Pose), new Point(elementScore2Pose)));
        score2.setLinearHeadingInterpolation(element2Pose.getHeading(), elementScore2Pose.getHeading());

        element3 = new Path(new BezierCurve(new Point(elementScore2Pose), new Point(element3Pose)));
        element3.setLinearHeadingInterpolation(elementScore2Pose.getHeading(), element3Pose.getHeading(), 0.5);

        score3 = new Path(new BezierLine(new Point(element3Pose), new Point(elementScore3Pose)));
        score3.setLinearHeadingInterpolation(element3Pose.getHeading(), elementScore3Pose.getHeading());
