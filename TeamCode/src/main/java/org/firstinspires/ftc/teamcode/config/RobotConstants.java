...
public class RobotConstants {
    ...
    public static double
            ...
            LDIFFY_TRANSFERING = 0.1, LDIFFY_SCORING = 0.475, LDIFFY_DROP = 0.5, LDIFFY_START = 0.25,
            RDIFFY_TRANSFERING = 0.1, RDIFFY_SCORING = 0.475, RDIFFY_DROP = 0.5, RDIFFY_START = 0.25,
