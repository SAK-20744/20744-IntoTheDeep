...
public class RobotConstants {
    ...
    public static double
            ...
            LDIFFY_TRANSFERING = 0.15, LDIFFY_CLIPPING = 0.42, LDIFFY_SCORING = 0.64, LDIFFY_WALL = 0.94, LDIFFY_AUTO = 0.64,
            RDIFFY_TRANSFERING = 0.21, RDIFFY_CLIPPING = 0, RDIFFY_SCORING = 0.6, RDIFFY_WALL = 0.80, RDIFFY_AUTO = 0.6,
            CLAW_CLOSED = 0.55, CLAW_OPEN = 0.17,
            WRIST_TRANSFERING = 0.9, WRIST_UP = 0.5785, WRIST_INTAKING = 0.2, WRIST_CLOSE_INTAKING = 0.13,
            DOOR_OPEN = 0.6, DOOR_CLOSED = 0.2,
            ROLL_DEPO = 0.85, ROLL_TRANSFERING = 0.135,
            RAIL_TRANSFERING = 0.1, RAIL_WALL= 0.35, RAIL_SCORING = 0, RAIL_CLIPPING = 1,
            E_RETRACT_POWER = -0.15;

    public static int
            LIFT_RETRACTED = -2, LIFT_MID_BASKET = 500, LIFT_HIGH_BASKET = 1300, LIFT_HIGH_RUNG = 444, LIFT_HIGH_RUNG_ADJUSTED = 458,  LIFT_AUTO_RUNG = 478, LIFT_MID_RUNG = 300, clipRange = 20,
