...
public class RobotConstants {
    ...
    public static double
            ...
            RDIFFY_TRANSFERING = 0.88, RDIFFY_CLIPPING = 1, RDIFFY_SCORING = 0.4, RDIFFY_WALL = 0.02, RDIFFY_AUTO = 0.35,
            CLAW_CLOSED = 0.1, CLAW_OPEN = 0.34, CLAW_SPEC = 0.38,
            WRIST_TRANSFERING = 1, WRIST_UP = 0.625, WRIST_INTAKING = 0.32, WRIST_CLOSE_INTAKING = 0.225,
