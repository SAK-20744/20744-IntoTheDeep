...
public class RobotConstants {
    ...
    public static double
            ...
            LDIFFY_TRANSFERING = 0.854, LDIFFY_CLIPPING = 0.56, LDIFFY_SCORING = 0.4375, LDIFFY_WALL = 0.07, LDIFFY_AUTO = 0.4, LDIFFY_NEW_AUTO = 0.6,
            ...
            WRIST_TRANSFERING = 1, WRIST_UP = 0.72, WRIST_INTAKING = 0.34, WRIST_CLOSE_INTAKING = 0.28,
            DOOR_OPEN = 0.6, DOOR_CLOSED = 0.2,
            ROLL_DEPO = 0.75, ROLL_TRANSFERING = 0.16, YAW = 0.125,
            LRAIL_TRANSFERING = 0.97, LRAIL_WALL= 0.9, LRAIL_SCORING = 1, LRAIL_CLIPPING = 0,
            RRAIL_TRANSFERING = 0.97, RRAIL_WALL= 0.9, RRAIL_SCORING = 1, RRAIL_CLIPPING = 0,
            E_RETRACT_POWER = -0.5,
            redVal = 0.035, blueVal = 0.02, greenVal = 0.5,
            grabtime = 0.18,
            wristNeeded = 135;
