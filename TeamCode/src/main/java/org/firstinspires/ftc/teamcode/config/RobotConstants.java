...
public class RobotConstants {
    ...
    public static double
            ...
            LDIFFY_TRANSFERING = 0.1, LDIFFY_SCORING = 0.49, LDIFFY_DROP = 0.5, LDIFFY_START = 0.25,
            RDIFFY_TRANSFERING = 0.1, RDIFFY_SCORING = 0.49, RDIFFY_DROP = 0.5, RDIFFY_START = 0.25,
            CLAW_CLOSED = 0.285, CLAW_OPEN = 0.65, CLAW_SPEC = 0.38, CLAW_INT = 0.3105,
