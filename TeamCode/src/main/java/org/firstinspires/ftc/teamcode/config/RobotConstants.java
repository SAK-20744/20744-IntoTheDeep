...
public class RobotConstants {
    ...
    public static double
            ...
            LDIFFY_TRANSFERING = 0.1, LDIFFY_SCORING = 0.475, LDIFFY_DROP = 0.5, LDIFFY_START = 0.25, LDIFFY_PICKUP = 0.8,
            RDIFFY_TRANSFERING = 0.1, RDIFFY_SCORING = 0.475, RDIFFY_DROP = 0.5, RDIFFY_START = 0.25, RDIFFY_PICKUP = 0.8,
    ...
    public static int
            LIFT_RETRACTED = -7, LIFT_MID_BASKET = 500, LIFT_HIGH_BASKET = 1350, LIFT_HIGH_RUNG = 250, LIFT_HIGH_RUNG_ADJUSTED = 458,  LIFT_AUTO_RUNG = 378, LIFT_MID_RUNG = 300, LIFT_SPEC_RETRACTED = 150, clipRange = 20,
