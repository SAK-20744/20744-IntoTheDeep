...
public class RobotConstants {
    ...
    public static double
            ...
            LRAIL_TRANSFERING = 1, LRAIL_WALL= 0.9, LRAIL_SCORING = 1, LRAIL_CLIPPING = -0.53,
            RRAIL_TRANSFERING = 1, RRAIL_WALL= 0.9, RRAIL_SCORING = 1, RRAIL_CLIPPING = -0.53,
            E_RETRACT_POWER = -0.5,
    ...
    public static int
            LIFT_RETRACTED = -7, LIFT_MID_BASKET = 500, LIFT_HIGH_BASKET = 1350, LIFT_HIGH_RUNG = 410, LIFT_HIGH_RUNG_ADJUSTED = 458,  LIFT_AUTO_RUNG = 375, LIFT_MID_RUNG = 300, clipRange = 20,
