...
public class AdidasTeleopV2 extends OpMode {
    ...
    public static double INTAKE_IN = 1, INTAKE_OUT = -1, INTAKE_OFF = 0, V4B_IN = 0.275, V4B_OUT = 0.5, TRANSFER_CLOSED = 0.63, TRANSFER_OPEN = 0.17, EXTENDO_RETRACTED = 0.11, EXTENDO_EXTENDED = 0.5, WRIST_TRANSFERING = 0.12, WRIST_UP = 0.78, WRIST_INTAKING = 0.882, DOOR_OPEN = 0.5, DOOR_CLOSED = 0.96, PITCH_DEPO = 0.3, PITCH_TRANSFERING = 0.765;
