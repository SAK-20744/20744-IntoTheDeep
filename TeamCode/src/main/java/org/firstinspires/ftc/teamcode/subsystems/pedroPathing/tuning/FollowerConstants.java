package org.firstinspires.ftc.teamcode.subsystems.pedroPathing.tuning;
...
import org.firstinspires.ftc.teamcode.subsystems.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.subsystems.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.subsystems.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 52;
    private static double yMovement = 32.4;
    ...
    public static double forwardZeroPowerAcceleration = -54.5;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -106.2;
