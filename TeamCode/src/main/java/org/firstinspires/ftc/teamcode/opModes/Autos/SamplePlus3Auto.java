...
//    private Pose sample2Pos = new Pose(20,10, Math.toRadians(0));
...
//        toPark.setLinearHeadingInterpolation(basketPos.getHeading(), avoidPos.getHeading(), 0.25);
...
//        telemetry.addData("Yaw", follower.getTotalHeading());
//        telemetry.update();
//
//    }
//
